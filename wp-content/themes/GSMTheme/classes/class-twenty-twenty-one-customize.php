...
if ( ! class_exists( 'Gsm_Theme_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Gsm Theme 1.0
	 */
	class Gsm_Theme_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->register_control_type( 'Gsm_Theme_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Gsm_Theme_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
