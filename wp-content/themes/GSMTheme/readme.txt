...
Gsm Theme is a blank canvas for your ideas and it makes the block editor your best brush.
...
Take it for a spin! See how Gsm Theme elevates your portfolio, business website, or personal blog.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Gsm Theme in the search form and press the 'Enter' key on your keyboard.
...
== Privacy ==
Gsm Theme uses LocalStorage to save the setting when Dark Mode support is turned on or off.
...
Gsm Theme WordPress Theme, 2020-2022 WordPress.org
Gsm Theme is distributed under the terms of the GNU GPL.
...
Gsm Theme is derived from Seedlet, (C) 2020 Automattic, Inc.

Gsm Theme is also based on:
