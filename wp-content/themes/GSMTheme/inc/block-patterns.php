...
if ( function_exists( 'register_block_pattern_category' ) ) {
	 ...
	 * @return void
	 */
	function gsm_theme_register_block_pattern_category() {
		register_block_pattern_category(
			'twentytwentyone',
			array( 'label' => esc_html__( 'Gsm Theme', 'twentytwentyone' ) )
		);
	}
	add_action( 'init', 'gsm_theme_register_block_pattern_category' );
}
...
if ( function_exists( 'register_block_pattern' ) ) {
	 ...
	 * @return void
	 */
	function gsm_theme_register_block_pattern() {
	...
	add_action( 'init', 'gsm_theme_register_block_pattern' );
}
